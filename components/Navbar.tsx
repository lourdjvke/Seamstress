...
const NAV_ITEMS = [
  ...
  { 
    ...
    href: '#',
    subLinks: [
      { label: 'Articles and Videos', href: '#' },
      { label: 'Business Plan Builder', href: '#' },
      { label: 'Funding Finder', href: '#' },
    ]
  },
  { 
    label: 'Manufacturing', 
    href: '#',
    subLinks: [
      { label: 'Supplier Guidelines', href: '#' },
    ...
    >
      <div className="flex justify-between items-center px-6 py-4">
        <div className="flex-1 flex items-center">
          <button aria-label="Menu" className="p-2 -ml-2 cursor-pointer">
