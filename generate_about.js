...
function AboutContent() {
  ...
  const activeData = ABOUT_DATA[currentTabId] || ABOUT_DATA['about-seamladies'];
    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans pt-20 md:pt-28">
      ...
      <div className="bg-white border-b border-gray-100">
        <nav className="flex overflow-x-auto whitespace-nowrap no-scrollbar py-4 px-6 gap-6 md:gap-10 justify-start md:justify-center items-center">
          {TAB_KEYS.map((key) => {
            const item = ABOUT_DATA[key];
            const isActive = activeData.id === item.id;
            return (
              <button
                key={item.id}
                onClick={() => setTab(item.id)}
                className={\`uppercase text-xs tracking-[0.12em] font-medium transition-colors cursor-pointer inline-block \${
                  isActive
      ...
      <section className="relative w-full h-[50vh] min-h-[400px] md:h-[60vh] md:min-h-[500px] overflow-hidden flex items-center justify-center bg-gray-100">
        ...
        <div className="relative z-10 text-white text-center uppercase px-3 w-full max-w-[92vw] md:max-w-[75vw] mx-auto min-h-[140px] sm:min-h-[120px] md:min-h-[100px] h-36 sm:h-32 md:h-28 flex items-center justify-center overflow-hidden">
          <AnimatePresence initial={false} mode="wait">
            <motion.h1
              ...
              className="absolute inset-0 flex items-center justify-center text-3xl sm:text-4xl md:text-5xl lg:text-6xl tracking-[0.12em] md:tracking-[0.2em] font-normal w-full text-center mx-auto leading-tight px-2 drop-shadow-md"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 lg:gap-24">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex justify-end">
                ...
                <button className="h-12 px-10 bg-gray-900 text-white text-[11px] tracking-[0.15em] uppercase font-medium hover:bg-gray-800 transition-colors cursor-pointer">
                  Submit
                </button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-0 min-h-[580px]">
              ...
              <div className="order-2 md:order-1 flex flex-col justify-center px-6 md:px-16 lg:px-24 xl:px-28 py-10 md:py-16">
                <div className="flex gap-8 border-b border-gray-200 mb-8 overflow-x-auto no-scrollbar">
                  {activeData.tabSliderBlock.map((slide, idx) => {
...
console.log('Done writing app/about/page.tsx');
